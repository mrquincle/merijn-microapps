...
env.Append(
    BUILDERS = dict(
        build_elf_tmp=Builder(
            action="$CC $CCFLAGS $CORE_FILES $SOURCE -I$LINKER_DIR -I$CORE -L$INCLUDE -T$GENERIC_GCC_NRF52_LD -o $TARGET",
        ),
        ...
        build_elf=Builder(
            action="$CC $CCFLAGS $CORE_FILES $SOURCE $HEADER_LD -I$CORE -I$LINKER_DIR -L$INCLUDE -T$GENERIC_GCC_NRF52_LD -o $TARGET",
        ),
