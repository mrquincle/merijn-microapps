...
env.Append(
    BLUENET_SHARES=[join(FRAMEWORK_DIR, "cores", board.get("build.core"),
        "SDK", "components", "microapp" "bluenet_shares" )
    ],
    MICROAPPS_INCLUDE=[join(FRAMEWORK_DIR, "cores", board.get("build.core"),
        "SDK", "components", "microapp" "include" )
    ],
    MICROAPPS_SYMBOLS_INPUT=[join(FRAMEWORK_DIR, "cores", board.get("build.core"),
        "SDK", "components", "microapp", "include", "microapp_symbols.ld.in")
    ],
    MICROAPPS_SYMBOLS_OUTPUT=[join(FRAMEWORK_DIR, "cores", board.get("build.core"),
        "SDK", "components", "microapp", "include", "microapp_symbols.ld")
    ],
)
